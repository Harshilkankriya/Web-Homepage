    ...
    return (
        <footer className="bg-slate-900 text-slate-300 pt-20 pb-10">
            <div className="max-w-[1400px] mx-auto px-6 sm:px-8 lg:px-12">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-10 mb-16">
                    <div className="col-span-2 md:col-span-1">
                        ...
                        <p className="text-base text-slate-400 leading-relaxed max-w-xs">
                            Connecting India's best founders with top investors. Apply, pitch, and grow.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            {[
                                ...
                                { name: 'For Investors', to: 'investors' },
                                { name: 'Startups', to: 'startups' }
                            ].map(link => (
                                <li key={link.name}>
                                    <Link to={link.to} smooth={true} duration={500} className="text-base hover:text-red-500 cursor-pointer transition-colors">
                                        {link.name}
                                    </Link>
                                </li>
                            ))}
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            {['Blog', 'Careers', 'Press Kit', 'Contact'].map(item => (
                                <li key={item}>
                                    <a href="#" className="text-base hover:text-red-500 transition-colors">{item}</a>
                                </li>
                            ))}
                        </ul>
                    </div>
                ...
                <div className="pt-10 border-t border-slate-800 flex flex-col md:flex-row justify-between items-center gap-5">
